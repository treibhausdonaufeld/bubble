...
export type Book = {
    ...
    readonly co_owners: CoOwnersList;
...
export type PaginatedAuthorListWritable = {
    count: number;
    next?: string | null;
    previous?: string | null;
    results: Array<AuthorWritable>;
};
...
export type PaginatedGenreListWritable = {
    count: number;
    next?: string | null;
    previous?: string | null;
    results: Array<GenreWritable>;
};
...
export type PaginatedShelfListWritable = {
    count: number;
    next?: string | null;
    previous?: string | null;
    results: Array<ShelfWritable>;
};
